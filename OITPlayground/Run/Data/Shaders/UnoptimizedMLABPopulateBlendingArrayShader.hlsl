...
void PixelMain(v2p_t input)
{
    ...
    {
        // First time seeing a fragment at the screen position( given texel coords )
        // Add fragment to the blending array
    ...
    {
        // Sort blending array in place and add incoming fragment to the array
        ...
        // If the blending array is about to be overflown, then blend the last two entries in the blending array to create room
